...
export declare function createProgram(gl: WebGL2RenderingContext, vertexShaderSource: string, fragmentShaderSource: string, name?: string): WebGLProgram;
export declare function createFloatTexture(gl: WebGL2RenderingContext, width: number, height?: number): WebGLTexture;
export declare function createFramebuffer(gl: WebGL2RenderingContext, texture: WebGLTexture, name?: string): WebGLFramebuffer;
