export declare class WebCLProgram<DATA_TEXTURE extends string = string, OUTPUT_TEXTURE extends string = string, UNIFORM extends string = string> {
    ...
    private asyncReadPBO;
    private asyncReadFramebuffer;
    private asyncReadArray;
    private asyncReadFence;
    ...
    startAsyncDataRead(textureName: DATA_TEXTURE): boolean;
    pollAsyncDataRead(): Float32Array | null;
    cancelAsyncRead(): void;
