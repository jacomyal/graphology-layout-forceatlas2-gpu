...
export declare class Index<DATA_TEXTURE extends string = string, OUTPUT_TEXTURE extends string = string, UNIFORM extends string = string> {
    ...
    constructor({ gl, fragments, dataTextures, outputTextures, fragmentShaderSource, vertexShaderSource, }: {
        gl: WebGL2RenderingContext;
        fragments: number;
        dataTextures: {
            name: DATA_TEXTURE;
    ...
    kill(): void;
    static wirePrograms(programs: Record<string, Index>): void;
}
